...
class move_line(Node):
    ...
    def send_request(self):
        self.req.pose = [self.x, self.y, self.z, 3.14, 0.0, 0.0]
    ...
    def sub_centroid_callback(self, msg):
        ...
        self.y = float(target[0][1] * 1000 +30)
        self.z = float(target[0][2] * 1000 + 100)
        self.get_logger().info("Centroid received x: {}, y: {}, z: {}".format(self.x, self.y, self.z))
def main(args=None):
