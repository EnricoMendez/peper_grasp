...
class RGBDPointCloudGenerator(Node):
    ...
    def color_callback(self, msg):
        ...
        cv2.imwrite('color.png', self.latest_color_image)
    
    def depth_callback(self, msg):
        self.latest_depth_image = self.bridge.imgmsg_to_cv2(msg, desired_encoding="passthrough")
        cv2.imwrite('depth.png', self.latest_depth_image)
    ...
    def timer_callback(self):
        ...
        # centroid_msg = self.np2ros([centroid], 'camera_color_optical_frame')
        # self.pub_centroid.publish(centroid_msg)
